var Framer = {
    ...
    drawTick: function (x1, y1, x2, y2) {
        ...
        gradient.addColorStop(0, '#E6D9B8');
        gradient.addColorStop(0.6, '#E6D9B8');
    ...
    drawEdging: function () {
        this.context.save();
        this.context.beginPath();
        this.context.strokeStyle = 'rgba(230, 217, 184, 0.5)';
        this.context.lineWidth = 1;
...
var Tracker = {
    ...
    drawArc: function () {
        this.context.save();
        this.context.strokeStyle = 'rgba(230, 217, 184, 0.8)';
        this.context.beginPath();
...
var Scene = {
    ...
    canvasConfigure: function () {
        ...
        this.context.strokeStyle = '#E6D9B8';
        this.calculateSize();
    },
...
var Controls = {
    ...
    drawPic: function () {
        this.context.save();
        this.context.beginPath();
        this.context.fillStyle = 'rgba(230, 217, 184, 0.9)';
        this.context.lineWidth = 1;

var Framer = {
    ...
    drawTick: function (x1, y1, x2, y2) {
        ...
        gradient.addColorStop(0, '#ef581d');
        gradient.addColorStop(0.6, '#ef581d');
        gradient.addColorStop(1, '#8aa7a9');
        this.context.beginPath();
    ...
    drawEdging: function () {
        this.context.save();
        this.context.beginPath();
        this.context.strokeStyle = 'rgba(239, 88, 29, 0.5)';
        this.context.lineWidth = 1;
...
var Tracker = {
    ...
    drawArc: function () {
        this.context.save();
        this.context.strokeStyle = 'rgba(239, 88, 29, 0.8)';
        this.context.beginPath();
...
var Scene = {
    ...
    canvasConfigure: function () {
        ...
        this.context.strokeStyle = '#ef581d';
        this.calculateSize();
    },
...
var Controls = {
    ...
    drawPic: function () {
        ...
        this.context.save();
        this.context.beginPath();
        this.context.fillStyle = 'rgba(239, 88, 29, 0.9)';
        this.context.lineWidth = 1;

var Framer = {
    ...
    drawTick: function (x1, y1, x2, y2) {
        ...
        gradient.addColorStop(0, '#B99A66');
        gradient.addColorStop(0.6, '#B99A66');
        gradient.addColorStop(1, '#211912');
        this.context.beginPath();
    ...
    drawEdging: function () {
        this.context.save();
        this.context.beginPath();
        this.context.strokeStyle = 'rgba(185, 154, 102, 0.5)';
        this.context.lineWidth = 1;
...
var Tracker = {
    ...
    drawArc: function () {
        this.context.save();
        this.context.strokeStyle = 'rgba(113, 52, 47, 0.9)';
        this.context.beginPath();
...
var Scene = {
    ...
    canvasConfigure: function () {
        ...
        this.context.strokeStyle = '#B99A66';
        this.calculateSize();
    },
...
var Controls = {
    ...
    drawPic: function () {
        this.context.save();
        this.context.beginPath();
        this.context.fillStyle = 'rgba(185, 154, 102, 0.9)';
        this.context.lineWidth = 1;

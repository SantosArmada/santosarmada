var Framer = {
    ...
    drawTick: function (x1, y1, x2, y2) {
        ...
        gradient.addColorStop(0, '#e6b882');
        gradient.addColorStop(0.6, '#e6b882');
        gradient.addColorStop(1, '#467489');
        this.context.beginPath();
    ...
    drawEdging: function () {
        this.context.save();
        this.context.beginPath();
        this.context.strokeStyle = 'rgba(230, 184, 130, 0.5)';
        this.context.lineWidth = 1;
...
var Tracker = {
    ...
    drawArc: function () {
        this.context.save();
        this.context.strokeStyle = 'rgba(230, 184, 130, 0.8)';
        this.context.beginPath();
...
var Scene = {
    ...
    canvasConfigure: function () {
        ...
        this.context.strokeStyle = '#e6b882';
        this.calculateSize();
    },
...
var Controls = {
    ...
    drawPic: function () {
        ...
        this.context.save();
        this.context.beginPath();
        this.context.fillStyle = 'rgba(230, 184, 130, 0.9)';
        this.context.lineWidth = 1;

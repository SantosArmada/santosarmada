var Framer = {
    ...
    drawTick: function (x1, y1, x2, y2) {
        ...
        gradient.addColorStop(0, '#1C6178');
        gradient.addColorStop(0.6, '#1C6178');
    ...
    drawEdging: function () {
        this.context.save();
        this.context.beginPath();
        this.context.strokeStyle = 'rgba(28, 97, 120, 0.5)';
        this.context.lineWidth = 1;
...
var Tracker = {
    ...
    drawArc: function () {
        this.context.save();
        this.context.strokeStyle = 'rgba(28, 97, 120, 0.8)';
        this.context.beginPath();
...
var Scene = {
    ...
    canvasConfigure: function () {
        ...
        this.context.strokeStyle = '#1C6178';
        this.calculateSize();
    },
...
var Controls = {
    ...
    drawPic: function () {
        this.context.save();
        this.context.beginPath();
        this.context.fillStyle = 'rgba(28, 97, 120, 0.9)';
        this.context.lineWidth = 1;

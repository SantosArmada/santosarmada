...
const TIMELINE_ENTRIES = [
  ...
  },
  {
    ...
    descriptionHtml:
      'Nacido el 17 de febrero de 1940 en <button type="button" class="timeline-detail-geolink" data-region="Guadalajara, Jalisco" data-country="México">Huentitán el Alto</button>, un barrio humilde a las afueras de Guadalajara, Vicente Fernández crece ordeñando vacas y cantando en fiestas antes de convertirse, décadas después, en \'El Charro de Huentitán\': la voz definitiva de la ranchera y el ícono más reconocible del mariachi del siglo XX. Con más de 50 discos, docenas de películas y rancheras como \'Volver, volver\' convertidas en himno nacional extraoficial, construye una carrera que atraviesa generaciones sin perder nunca su acento de pueblo ni su identidad de charro. Muere el 12 de diciembre de 2021 en <button type="button" class="timeline-detail-geolink" data-region="Guadalajara, Jalisco" data-country="México">Guadalajara</button>, la misma ciudad que lo vio nacer pobre y despedirlo como leyenda.',
    butterfly: {
